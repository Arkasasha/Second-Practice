...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Size = System::Drawing::Size(193, 20);
			this->label5->TabIndex = 4;
			this->label5->Text = L"Eleonora Černikovaitė";
			// 
			// btn_log_out
			// 
			...
			this->btn_log_out->Click += gcnew System::EventHandler(this, &Management::btn_log_out_Click);
			// 
			// tableLayoutPanel1
			// 
			...
			this->label23->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label23->Location = System::Drawing::Point(309, 7);
			this->label23->Name = L"label23";
			this->label23->Size = System::Drawing::Size(46, 36);
			this->label23->TabIndex = 18;
			this->label23->Text = L"AR (0.15)";
			...
			this->label24->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label24->Location = System::Drawing::Point(363, 7);
			this->label24->Name = L"label24";
			this->label24->Size = System::Drawing::Size(46, 36);
			this->label24->TabIndex = 19;
			this->label24->Text = L"AR (0.15)";
			...
			this->label27->Size = System::Drawing::Size(34, 20);
			this->label27->TabIndex = 20;
			this->label27->Text = L"AR";
			// 
			// label28
			// 
			...
			this->label28->Text = L"- Written survey";
			// 
			// Management
			// 
